...
typedef void* ptrDato;                                                          //Cambiado del original
typedef ResultadoComparacion (*PFComparacion) (ptrDato, ptrDato);               //Cambiado del original
ResultadoComparacion compararDato(ptrDato dato1, ptrDato dato2);                //Cambiado del original
/* Tipo de Estructura de los Nodos de la Lista. */
struct NodoLista {
    ptrDato ptrdato; // dato almacenado                                         //Cambiado del original
...
struct Lista{                                                                   //Cambiado del original
    PtrNodoLista primero;
    PFComparacion compara;      // puntero al primer nodo de la lista
};
...
void crearLista(Lista &lista, PFComparacion compara);                           //Cambiado del original
